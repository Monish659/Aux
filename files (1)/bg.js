...
function initBg(bgId, shardId, palette) {
  ...
  const palettes = {
    amber: {
      // warm white-orange: center is hot white, lines are amber/gold
      bgBase: '#fdf5e6',
      coreStops: [
        [0,    'rgba(255,255,255,1)'],
        [0.06, 'rgba(255,252,240,1)'],
        [0.18, 'rgba(255,244,210,0.97)'],
        [0.32, 'rgba(255,225,160,0.88)'],
        [0.52, 'rgba(255,195,90,0.52)'],
        [0.72, 'rgba(220,140,30,0.22)'],
        [0.88, 'rgba(160,80,0,0.08)'],
        [1,    'rgba(60,20,0,0)'],
      ],
      lineColors: [
      ...
      vigStop2: 'rgba(190,120,30,0.06)',
      vigStop3: 'rgba(70,25,0,0.16)',
      vigStop4: 'rgba(20,8,0,0.30)',
      shardPurple: true,
    },
    blue: {
      bgBase: '#f0f4ff',
      coreStops: [
        [0,    'rgba(255,255,255,1)'],
        [0.08, 'rgba(245,248,255,1)'],
        [0.2,  'rgba(220,232,255,0.96)'],
        [0.38, 'rgba(180,210,255,0.82)'],
        [0.58, 'rgba(120,170,255,0.45)'],
        [0.75, 'rgba(60,110,240,0.18)'],
        [0.9,  'rgba(20,50,180,0.06)'],
        [1,    'rgba(0,0,0,0)'],
      ],
      lineColors: [
      ...
      vigStop2: 'rgba(80,130,255,0.05)',
      vigStop3: 'rgba(20,50,180,0.13)',
      vigStop4: 'rgba(5,15,80,0.28)',
      shardPurple: true,
    },
    violet: {
      bgBase: '#f5f0ff',
      coreStops: [
        [0,    'rgba(255,255,255,1)'],
        [0.07, 'rgba(250,248,255,1)'],
        [0.18, 'rgba(238,230,255,0.97)'],
        [0.34, 'rgba(210,195,255,0.86)'],
        [0.55, 'rgba(170,140,255,0.48)'],
        [0.74, 'rgba(120,80,240,0.2)'],
        [0.9,  'rgba(70,30,180,0.07)'],
        [1,    'rgba(0,0,0,0)'],
      ],
      lineColors: [
      ...
      vigStop2: 'rgba(120,80,240,0.05)',
      vigStop3: 'rgba(60,20,180,0.14)',
      vigStop4: 'rgba(15,5,60,0.30)',
      shardPurple: true,
    },
  };
