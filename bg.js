...
function initBg(bgId, shardId, palette) {
  const palettes = {
    ...
    'midnight-silver': {
      bgBase: '#0c0d10',
      coreStops:[
        [0,'rgba(200,212,235,0.08)'],[0.14,'rgba(165,178,205,0.05)'],
        [0.30,'rgba(130,145,172,0.03)'],[0.50,'rgba(85,98,125,0.015)'],
        [0.72,'rgba(38,48,65,0.008)'],[0.90,'rgba(10,14,22,0)'],
        [1,'rgba(0,0,0,0)'],
      ],
      lines:[{r:'228,234,245',g:'192,202,222',b:'152,165,190'},{r:'178,186,205',g:'135,146,168',b:'88,100,122'},{r:'105,115,138',g:'55,65,85',b:'22,30,46'}],
      vig:['rgba(185,198,225,0)','rgba(55,68,92,0.06)','rgba(6,9,16,0.50)','rgba(1,2,5,0.84)'],
      shard:[
        {f:[188,196,215], s:[238,242,252], fw:0.18, sw:1.0, lw:1.2},
        {f:[150,160,182], s:[208,214,230], fw:0.14, sw:1.3, lw:1.0},
        {f:[215,220,232], s:[248,250,255], fw:0.10, sw:1.5, lw:0.8},
        {f:[125,135,158], s:[178,186,205], fw:0.07, sw:2.0, lw:1.4},
        {f:[244,246,252], s:[255,255,255], fw:0.06, sw:2.2, lw:1.6},
      ],
    },
    'midnight-bronze': {
      bgBase: '#0f0c09',
      coreStops:[
        [0,'rgba(215,138,55,0.09)'],[0.14,'rgba(178,100,32,0.06)'],
        [0.30,'rgba(138,68,18,0.04)'],[0.50,'rgba(88,42,8,0.02)'],
        [0.72,'rgba(42,18,2,0.01)'],[0.90,'rgba(14,5,0,0)'],
        [1,'rgba(0,0,0,0)'],
      ],
      lines:[{r:'252,222,175',g:'228,158,78',b:'188,108,32'},{r:'192,132,72',g:'152,88,28',b:'98,52,6'},{r:'128,78,22',g:'78,40,4',b:'38,16,0'}],
      vig:['rgba(215,128,48,0)','rgba(68,30,4,0.07)','rgba(12,5,0,0.50)','rgba(2,1,0,0.84)'],
      shard:[
        {f:[182,102,38],  s:[238,172,95],  fw:0.18, sw:1.0, lw:1.2},
        {f:[205,185,162], s:[245,232,218], fw:0.14, sw:1.3, lw:1.0},
        {f:[152,78,24],   s:[212,145,68],  fw:0.10, sw:1.5, lw:0.8},
        {f:[225,205,178], s:[252,240,225], fw:0.07, sw:2.0, lw:1.4},
        {f:[245,192,115], s:[255,232,182], fw:0.06, sw:2.2, lw:1.6},
      ],
    },
    'midnight-steel': {
      bgBase: '#090b10',
      coreStops:[
        [0,'rgba(75,138,225,0.09)'],[0.14,'rgba(50,98,182,0.06)'],
        [0.30,'rgba(32,62,142,0.04)'],[0.50,'rgba(15,35,90,0.02)'],
        [0.72,'rgba(5,14,45,0.01)'],[0.90,'rgba(1,4,18,0)'],
        [1,'rgba(0,0,0,0)'],
      ],
      lines:[{r:'195,218,252',g:'145,185,242',b:'88,138,212'},{r:'165,198,242',g:'108,152,218',b:'52,102,185'},{r:'112,152,212',g:'58,98,175',b:'22,52,130'}],
      vig:['rgba(55,118,212,0)','rgba(12,32,78,0.07)','rgba(3,7,22,0.50)','rgba(0,1,8,0.84)'],
      shard:[
        {f:[45,92,175],   s:[105,162,248], fw:0.18, sw:1.0, lw:1.2},
        {f:[182,200,228], s:[222,234,250], fw:0.14, sw:1.3, lw:1.0},
        {f:[68,128,218],  s:[152,198,248], fw:0.10, sw:1.5, lw:0.8},
        {f:[202,214,235], s:[240,245,255], fw:0.07, sw:2.0, lw:1.4},
        {f:[125,172,238], s:[192,222,255], fw:0.06, sw:2.2, lw:1.6},
      ],
    },
    'midnight-emerald': {
      bgBase: '#090f0b',
      coreStops:[
        [0,'rgba(55,178,98,0.09)'],[0.14,'rgba(32,138,68,0.06)'],
        [0.30,'rgba(16,98,42,0.04)'],[0.50,'rgba(6,52,20,0.02)'],
        [0.72,'rgba(1,20,6,0.01)'],[0.90,'rgba(0,6,1,0)'],
        [1,'rgba(0,0,0,0)'],
      ],
      lines:[{r:'182,238,208',g:'118,208,152',b:'58,172,98'},{r:'152,208,172',g:'82,168,112',b:'32,128,62'},{r:'88,158,112',g:'32,112,58',b:'8,62,22'}],
      vig:['rgba(38,158,82,0)','rgba(6,38,14,0.07)','rgba(0,9,2,0.50)','rgba(0,2,0,0.84)'],
      shard:[
        {f:[22,102,52],   s:[68,188,118],  fw:0.18, sw:1.0, lw:1.2},
        {f:[168,208,185], s:[212,238,222], fw:0.14, sw:1.3, lw:1.0},
        {f:[45,145,82],   s:[102,212,148], fw:0.10, sw:1.5, lw:0.8},
        {f:[195,220,205], s:[232,248,238], fw:0.07, sw:2.0, lw:1.4},
        {f:[85,192,128],  s:[148,228,178], fw:0.06, sw:2.2, lw:1.6},
      ],
    },
  };
